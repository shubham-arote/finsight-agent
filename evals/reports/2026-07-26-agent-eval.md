...
Date: 2026-07-26 · Agent mode: **cloud LLM** · Judge: **offline** · Dataset: sample_report_qa.json (21 in-scope + 4 out-of-scope)

| Metric | Score |
|---|---|
| Abstain accuracy (OOS refused) | **100%** |
| Answer rate (in-scope answered) | **100%** |
| Citation hit (cited source on an expected page) | **100%** |
| Verified rate (zero unverified figures) | **95%** |
...
| in | What was revenue in the prior year, FY25? | calc | ✗ | [2, 4, 5] | ✓ | ✓ | — |
